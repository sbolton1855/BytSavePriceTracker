...
echo "Testing Amazon Search API..."

# Save response to file
curl -v "https://webservices.amazon.com/paapi5/searchitems" \
...
}' > search-response.txt 2>&1

echo -e "\nResponse saved to search-response.txt:"
cat search-response.txt 