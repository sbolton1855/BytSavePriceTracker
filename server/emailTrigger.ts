...
export async function testEmailNotification(email: string): Promise<boolean> {
  try {
    ...
    const info = await transporter.sendMail({
      from: '"BytSave Price Alerts" <alerts@bytsave.com>',
      to: email,
      subject: 'BytSave Email System Test',
      text: 'This is a test email from BytSave to verify your email notification system is working correctly.',
      html: `
